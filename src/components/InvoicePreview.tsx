...
const InvoicePreview = ({ invoice, isGujarati = false, template }: InvoicePreviewProps) => {
  ...
  const tableColor = template?.tableColor || '#f8f9fa';
    ...
    <Card className="w-full print:shadow-none">
      <CardContent className="p-8 print:p-6">
        <div className="flex flex-col gap-6 print:gap-4">
          ...
          <div className={`${headerAlignmentClass} relative`}>
            <div className="flex justify-between items-start">
              <div className={headerPosition === 'right' ? 'order-2' : ''}>
                <h1 
                  className="text-2xl font-bold print:text-xl mb-2" 
                  style={{ color: primaryColor }}
                >
                  {isGujarati ? 'કોટેશન' : 'Quotation'}
                </h1>
                <p className="font-semibold mb-1">Sharda Mandap Service</p>
                <p className="text-gray-600 print:text-gray-800 text-sm mb-1">
              ...
              {showLogo && (
                <div className={`w-20 h-20 border border-dashed rounded p-2 flex items-center justify-center ${
          ...
          <hr style={{ borderColor: secondaryColor }} />

          {/* Invoice Info */}
          <div>
            <h2 className="text-xl font-bold mb-3 print:text-lg print:mb-2" style={{ color: primaryColor }}>
          ...
          <div>
            ...
            <div className="flex flex-col items-end">
              <div className="w-full max-w-xs">
                ...
                <div 
                  className="flex justify-between font-bold border-t pt-2 mt-2 text-sm print:text-xs"
          ...
          {footerDesign === 'detailed' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm print:text-xs" style={{ color: secondaryColor }}>
              <div>
          ...
          {footerDesign === 'minimal' && (
            <div className="flex justify-between items-center text-sm print:text-xs" style={{ color: secondaryColor }}>
              <div>
                <p>Thank you</p>
              </div>
              <div>
